...
/* harmony import */ var _libs_fs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
/* harmony import */ var _libs_path__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9);
/* harmony import */ var _visitor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11);
...
function Config(code, options) {
  ...
  switch (options.fileExt) {
    ...
    case '.flow.js':
      plugins.push.apply(plugins, flowPlugins);
      break;
    ...
    default:
      plugins.push.apply(plugins, dynamicFlowPlugins);
      break;
...
/* harmony import */ var typescript__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
...
var parse = function parse(code, config) {
  ...
  if (config.plugins.includes('typescript')) {
    code = typescript__WEBPACK_IMPORTED_MODULE_2__["transpileModule"](code, {
      compilerOptions: {
        target: typescript__WEBPACK_IMPORTED_MODULE_2__["ScriptTarget"].ES2018,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _babel_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
...
/* harmony default export */ __webpack_exports__["default"] = (function (code, out) {
  ...
  var pluckMagicTemplateLiteral = function pluckMagicTemplateLiteral(node) {
    ...
    var gqlTemplateLiteral = pluckStringFromFile(node);
