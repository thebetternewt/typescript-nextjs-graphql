...
exports.loadSchema = async (schemaDef, config) => {
    ...
    try {
        ...
        return graphql_toolkit_1.loadSchema(pointToSchema, options);
    }
    catch (e) {
...
exports.loadDocuments = async (documentDef, config) => {
    ...
    return graphql_toolkit_1.loadDocuments(documentDef, loadDocumentsToolkitConfig);
};
