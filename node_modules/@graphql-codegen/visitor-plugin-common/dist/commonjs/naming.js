...
function convertFactory(config) {
    function resolveConventionName(type) {
        if (!config.namingConvention) {
            return (str, opts = {}) => {
                return utils_1.convertNameParts(str, change_case_1.pascalCase, !!(opts || {}).transformUnderscore);
            };
        }
        if (typeof config.namingConvention === 'string') {
            ...
            return (str, opts = {}) => {
                return utils_1.convertNameParts(str, plugin_helpers_1.resolveExternalModuleAndFn(config.namingConvention), !!(opts || {}).transformUnderscore);
            };
        }
        if (typeof config.namingConvention === 'function') {
            return (str, opts = {}) => {
                return utils_1.convertNameParts(str, config.namingConvention, !!(opts || {}).transformUnderscore);
            };
        }
        ...
        if (typeof config.namingConvention === 'object') {
            if (!config.namingConvention[type]) {
                return (str, opts = {}) => {
                    return utils_1.convertNameParts(str, change_case_1.pascalCase, config.namingConvention['transformUnderscore'] || !!(opts || {}).transformUnderscore);
                };
            }
            return (str, opts = {}) => {
                return utils_1.convertNameParts(str, plugin_helpers_1.resolveExternalModuleAndFn(config.namingConvention[type]), config.namingConvention['transformUnderscore'] || !!(opts || {}).transformUnderscore);
            };
        }
