...
class SelectionSetToObject {
    ...
    _collectField(field) {
        ...
        if (graphql_1.isObjectType(this._parentSchemaType) || graphql_1.isInterfaceType(this._parentSchemaType)) {
            let schemaField;
            if (utils_1.isRootType(this._parentSchemaType, this._schema) && isMetadataFieldName(field.name.value)) {
    ...
    buildFragments(fragments) {
        ...
        else if (graphql_1.isObjectType(this._parentSchemaType)) {
    ...
    _handleFragmentsForObjectType(fragments) {
        ...
        return utils_1.quoteIfNeeded(fragmentsValue, ' & ');
    }
